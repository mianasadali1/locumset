...
import { TouchableOpacity, StyleSheet, Platform, Dimensions, View, Image, TextInput } from 'react-native';
...
import Logo from '../Themes/assets/imgs/logo.png';
...
class Header extends React.Component {
  ...
  render() {
    ...
    return (
      <Block center style={{backgroundColor: '#009b8b', width: width, paddingTop: 30, paddingBottom: 5}}>
          <Image center source={ Logo } />
          {this.renderHeader()}
          <OfflineNotice />
      </Block>
    );
